...
public class CryptoWeekly extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_crypto_weekly);

    setTitle("Weekly Data Chart");
      ...
      public void onClick(View v) {
        new CountDownTimer(2000, 1000) {
          ...
          public void onFinish() {
            try {
              finance.getCryptoWeekly(cryptoString, marketString);
              // sketch the graph
              ...
              x.setValueFormatter(new ValueFormatter() {
                ...
                public String getFormattedValue(float value) {
                  return formatDates(finance.datesWeekly).toString();
                }
              });
              x.setEnabled(true);
            ...
            Log.d("open vals: ", finance.valuesWeeklyOpen.toString());
            Log.d("close vals: ", finance.valuesWeeklyClose.toString());
  ...
  public List<String> formatDates(List<LocalDateTime> list){
    ...
    for(int i = 0; i < list.size();i++){
      list2.add(list.get(i).getDayOfWeek() + "." + list.get(i).getMonth().toString());
    }
    return list2;
  }
  ...
  public LineData getDataOpenValues() {
    ...
    if (finance.valuesWeeklyOpen.size() != 0 || finance.valuesWeeklyClose.size() != 0) {
      for (int i = 0; i < finance.valuesWeeklyOpen.size(); i++) {
        float val = finance.valuesWeeklyOpen.get(i).floatValue();
      ...
      for (int i = 0; i < finance.valuesWeeklyClose.size(); i++) {
        float val = finance.valuesWeeklyClose.get(i).floatValue();
