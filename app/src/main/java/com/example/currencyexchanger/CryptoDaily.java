...
public class CryptoDaily extends AppCompatActivity {

  final private String API_key = "API Key Here";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_crypto_daily);

    setTitle("Daily Data Chart");
        ...
        new CountDownTimer(2000, 1000) {
          ...
          public void onFinish() {
            ...
            try {
              ...
              finance.getCryptoDaily(cryptoString, marketString);
              // sketch the graph
              ...
              x.setValueFormatter(new ValueFormatter() {
                ...
                public String getFormattedValue(float value) {
                  return formatDates(finance.datesDaily).toString();
                }
              });
              x.setEnabled(true);
            ...
            Log.d("open vals: ", finance.valuesDailyOpen.toString());
            Log.d("close vals: ", finance.valuesDailyClose.toString());
  ...
  public List<String> formatDates(List<LocalDateTime> list) {
    ...
    for (int i = 0; i < list.size(); i++) {
      list2.add(list.get(i).getDayOfMonth() + "." + list.get(i).getMonth().toString());
    }
    return list2;
  }
  ...
  public LineData getDataOpenValues() {
    ...
    if (finance.valuesDailyOpen.size() != 0 || finance.valuesDailyClose.size() != 0) {
      for (int i = 0; i < finance.valuesDailyOpen.size(); i++) {
        float val = finance.valuesDailyOpen.get(i).floatValue();
      ...
      for (int i = 0; i < finance.valuesDailyClose.size(); i++) {
        float val = finance.valuesDailyClose.get(i).floatValue();
